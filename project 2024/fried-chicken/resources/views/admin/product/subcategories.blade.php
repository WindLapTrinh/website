                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="text-setting"
                                                    href="{{ $subcategory->children->count() > 0 ? route('category.product.subcategories', $subcategory->id) : '#' }}">
                                                    {{ $subcategory->name }}
                                                </a>
                                            </td>
                                            ...
                                            <td>
                                                <button
                                                    class="btn btn-success btn-sm rounded-0 text-white btn-edit-category-product btn-submit"
                ...
                <div class="modal-content">
                    ...
                    <form id="editCategoryForm" method="POST">
                        ...
                        <div class="modal-body row p-0 m-0">
                            ...
                            <div class="form-group col-12">
                                <label for="desc">Mô tả danh mục</label>
                                <textarea name="desc" class="form-control" id="mytextareaEditCategoryProduct" placeholder="Nhập mô tả danh mục"></textarea>
                            </div>
