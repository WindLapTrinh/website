                ...
                <div class="btn-group">
                    <a class="nav-link list-notify" href="#" id="alertsDropdown" role="button"
                        ...
                        @if (count($adminNotifications) > 0)
                            <span class=" badge-danger badge-counter">{{ count($adminNotifications) }}</span>
                        @endif
                    </a>
                    <div class="dropdown-list box-notification dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        @if (count($adminNotifications) > 0)
                            @foreach ($adminNotifications as $adminNotification)
                                <form action="{{ route('admin.notification.update', $adminNotification->id) }}"
                                    method="POST" style="display: inline;">
                                    @csrf
                                    <button type="submit" class="dropdown-item d-flex align-items-center">
                                        <div class="mr-3">
                                            <div class="small text-gray-500 date-notification">
                                                {{ $adminNotification->created_at->format('d/m/Y') }}
                                            </div>
                                        </div>
                                        <div class="header-notification">
                                            <div class="font-weight-bold title-notification">
                                                {{ $adminNotification->title }}</div>
                                            <div class="message-notification">{{ $adminNotification->message }}</div>
                                        </div>
                                    </button>
                                </form>
                            @endforeach
                        @else
                            <div class="header-notification">Hiện tại bạn chưa có thông báo nào ?</div>
                        @endif
                ...
                <ul id="sidebar-menu">
                    ...
                    <li class="nav-link">
                        <a class="name-parent" href="{{ url('admin/page/list') }}">
                            <div class="nav-link-icon d-inline-flex">
                                <i class="fas fa-user-tag icon-parent-menu"></i>
                            </div>
                            Khách hàng
                        </a>
                        ...
                        <ul class="sub-menu">
                            <li class="chilldent-menu-top ">
                                <a href={{ route('customer.potential') }}>
                                    Tiềm năng
                                </a>
                            </li>
                            <li class="chilldent-menu-bottom">
                                <a href={{ route('customer.purchased') }}>
                                    Đã mua hàng
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-link">
                        ...
                        <ul class="sub-menu">
                            <li class="chilldent-menu-top chilldent-menu-bottom"><a href={{ route('page.list') }}>Danh
                                    sách</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-link">
                        ...
                        <i class="arrow fas fa-angle-right"></i>
                        <ul class="sub-menu">
                            <li class="chilldent-menu-top"><a href="{{ url('admin/post/list') }}">Danh sách</a></li>
                    ...
                    <li class="nav-link">
                        ...
                        <i class="arrow fas fa-angle-right"></i>
                        <ul class="sub-menu">
                            <li class="chilldent-menu-top chilldent-menu-bottom"><a href={{ route('order.list') }}>Đơn
                                    hàng</a></li>
                        </ul>
                    </li>
                    <li class="nav-link">
                        ...
                        <ul class="sub-menu">
                            <li class="chilldent-menu-bottom chilldent-menu-top"><a
                                    href="#">Danh sách</a>
                            </li>
                        </ul>
                    </li>
